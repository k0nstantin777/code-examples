...
class AwaitEnterPaymentTransactionIDStateFlowTest extends TestCase
{
    use TelegramBotApiMock;
    use JsonRpcClientMock;
    use RefreshDatabase;

    public function testEnterTransactionIDMessageReceived(): void
    {
        ...
        $exchangeRequest->changeState(app(AwaitEnterPaymentTransactionIDState::class));
