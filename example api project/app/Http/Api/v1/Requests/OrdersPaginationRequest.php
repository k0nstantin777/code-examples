...
use App\Http\Api\v1\Rules\InvalidOrderIncludesValue;

class OrdersPaginationRequest extends IndexPaginationRequest
{
        ...
        return array_merge(parent::queryParameters(), [
            'includes' => [
                'description' => 'Field to attach additional data to response. Must be string of words: 
				 delivery_address, payment_address, delivery_service, payment_service, grave, products, coupon, comma separated. Defaults is empty.',
                'example' => 'delivery_address,delivery_service,payment_service,products',
            ],
            'status' => [
            ...
            'search' => [
                'description' => 'Field to filter by order ID, order number or part of it. Defaults is empty',
                'example' => 'RS-',
            ],
            'from' => [
